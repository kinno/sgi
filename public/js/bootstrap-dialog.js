...
(function($) {
    ...
    BootstrapDialog.elimina = function(titulo, message, callback) {
        return new BootstrapDialog({
            title: titulo,
    ...
    BootstrapDialog.mensaje = function(titulo, message, tipo, callback) {
        var vtipo;
        switch (tipo) {
            case 1:
                titulo = titulo || '\u00a1 Listo !';
                vtipo = BootstrapDialog.TYPE_SUCCESS;
                break;
            case 2:
                titulo = titulo || '\u00a1 Alerta !'
                vtipo = BootstrapDialog.TYPE_WARNING;
                break;
            case 3:
                titulo = titulo || "Error";
                vtipo = BootstrapDialog.TYPE_DANGER;
                break;
        }
        return new BootstrapDialog({
            title: titulo,
            message: function(dialog) {
                var $msj = $('<div><strong>' + message + '</strong></div>');
                return $msj;
            },
            type: vtipo,
            closable: false,
