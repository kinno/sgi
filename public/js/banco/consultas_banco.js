...
$(document).ready(function() {
    ...
    var table = $('#tablaObservaciones').DataTable({
        ...
        columns: [{
            ...
            data: 'hoja1.nombre_obra',
            name: 'hoja1.nombre_obra'
        }, {
            data: 'hoja1.unidad_ejecutora.nombre',
            name: 'hoja1.unidad_ejecutora.nombre'
        }, {
            data: 'movimientos[0].fecha_movimiento',
            name: 'movimientos.fecha_movimiento'
        }, {
            data: 'movimientos[0].status',
            name: 'movimientos.status'
        }, {
            "className": 'mto',
            data: 'hoja1.monto',
            name: 'hoja1.monto'
