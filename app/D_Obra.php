...
class D_Obra extends Model
{
	...
	{
		return $this->belongsToMany('App\Cat_Fuente','rel_obra_fuente','id_det_obra', 'id_fuente')->withPivot('monto', 'cuenta','partida','tipo_fuente', 'asignado', 'autorizado', 'ejercido', 'anticipo', 'retenciones', 'comprobado', 'pagado');
	}
	...
	public function clasificacion_obra()
	{
		return $this->belongsTo('App\Cat_Clasificacion_Obra', 'id_clasificacion_obra');
	}
	...
	{
		return $this->belongsTo('App\Cat_Municipio_Reporte', 'id_municipio');
	}

	public function cobertura()
	{
		return $this->belongsTo('App\Cat_Cobertura', 'id_cobertura');
	}
