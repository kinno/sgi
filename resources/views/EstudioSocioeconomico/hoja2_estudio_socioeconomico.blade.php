    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="panel-title">
                <strong>
                    ANEXO 2
                    <input id="id_hoja_dos" name="id_hoja_dos" type="hidden"></input>
        ...
        <div class="panel-body">
            <div class="form-group form-group-sm col-md-10" id="tipcob1">
                ...
                <div class="col-md-3">
                    <select class="form-control bnc am-as obligatorioHoja2 obligatorio input-sm" id="id_cobertura" name="id_cobertura">
                        <option value="">
                            Seleccione...
                        </option>
            ...
            <div class="form-group form-group-sm col-md-10 " hidden="true" id="comloc">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-5">
                        <input class="form-control bnc am-as input-sm" id="nombre_localidad" name="nombre_localidad" type="text">
                        </input>
                    </div>
            ...
            <div class="form-group form-group-sm col-md-10">
                ...
                <div class="col-md-3">
                    <select class="form-control bnc am-as input-sm" id="id_tipo_localidad" name="id_tipo_localidad">
                        <option value="">
                            Seleccione...
                        </option>
            ...
            <div class="form-group form-group-sm col-md-10">
                ...
                <div class="col-lg-2">
                    <select class="form-control bnc am-as input-sm" id="bcoordenadas" name="bcoordenadas">
                        <option value="">
                            Seleccionar...
                        </option>
                        <option value="1">
                ...
                <div class="col-lg-5">
                    <input class="form-control bnc am-as input-sm" id="observaciones_coordenadas" maxlength="100" name="observaciones_coordenadas" readonly="" type="text">
                        <div id="label3">
                        </div>
                    </input>
                </div>
            ...
            <div hidden="true" id="coordenadas">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as input-sm" id="latitud_inicial" name="latitud_inicial" placeholder="0.00" type="text">
                        </input>
                    </div>
                    <label class="col-md-2 control-label">
                        <font color="red" size="2">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as input-sm" id="longitud_inicial" name="longitud_inicial" placeholder="0.00" type="text">
                        </input>
                    </div>
                </div>
                <div class="form-group form-group-sm">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as input-sm" id="latitud_final" name="latitud_final" placeholder="0.00" type="text">
                        </input>
                    </div>
                    <label class="col-md-2 control-label">
                        LON:
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as input-sm" id="longitud_final" name="longitud_final" placeholder="0.00" type="text">
                        </input>
                    </div>
                </div>
                <div class="form-group form-group-sm col-md-10">
            ...
            <div class="form-group form-group-sm col-md-10">
              ...
              de las calles que la circundan.">
                ...
                <div class="col-md-7">
                    <input id="microlocalizacion" name="microlocalizacion" type="file" class="input-sm">
                    </input>
                </div>
            </div>
            <div class="form-group form-group-sm col-md-10">
            ...
            <div class="form-group form-group-sm col-md-10">
                ...
                <div class="col-md-7">
                    <input class="form-control input-sm" id="nomresp" name="nomresp" type="text">
                    </input>
                </div>
            </div>
            <div class="form-group form-group-sm col-md-10">
            ...
            <div class="form-group form-group-sm col-md-10">
                ...
                <div class="col-md-7">
                    <input class="form-control input-sm" id="telresp" name="telresp" onkeypress="return justNumbers(event);" type="text">
                    </input>
                </div>
            </div>
            <div class="form-group form-group-sm col-md-10">
                ...
                <div class="col-md-7">
                    <input class="form-control input-sm" id="emailresp" name="emailresp" type="text">
                    </input>
                </div>
            </div>
            <div class="form-group form-group-sm col-md-10">
