...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title text-center"><strong>Agregar Usuario</strong></h3>
	</div>
			...
			<div class="form-group" id="div_id_unidad_ejecutora">
            	<label for="id_unidad_ejecutora" class="col-md-2 control-label input-sm"><span class="obligatorio">*</span>Unidad Ejecutora:</label>
              	<div class="col-md-6">
                    ...
                    <span id="err_id_unidad_ejecutora" class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
              	</div>
			</div>
			</div>
...
<script src="{{ asset('js/Administracion/Usuario/usuario-guardar.js') }}"></script>
@endsection
