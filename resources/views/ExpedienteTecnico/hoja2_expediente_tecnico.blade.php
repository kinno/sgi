    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group col-md-10" id="tipcob1">
                ...
                <div class="col-md-3">
                    <select class="form-control bnc am-as obligatorioHoja2 obligatorio" id="id_cobertura" name="id_cobertura">
                        <option value="">
                            Seleccione...
                        </option>
            ...
            <div class="form-group col-md-10 " hidden="true" id="comloc">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input class="form-control bnc am-as" id="nombre_localidad" name="nombre_localidad" type="text">
                        </input>
                    </div>
            ...
            <div class="form-group col-md-10">
                ...
                <div class="col-md-3">
                    <select class="form-control bnc am-as obligatorioHoja2 obligatorio" id="id_tipo_localidad" name="id_tipo_localidad">
                        <option value="">
                            Seleccione...
                        </option>
            ...
            <div class="form-group col-md-10">
                ...
                <div class="col-lg-2">
                    <select class="form-control bnc am-as obligatorioHoja2 obligatorio" id="bcoordenadas" name="bcoordenadas">
                        <option value="">
                            Seleccionar...
                        </option>
                        <option value="1">
                ...
                <div class="col-lg-5">
                    <input class="form-control bnc am-as" id="observaciones_coordenadas" maxlength="100" name="observaciones_coordenadas" readonly="" type="text">
                        <div id="label3">
                        </div>
                    </input>
                </div>
            ...
            <div hidden="true" id="coordenadas">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as" id="latitud_inicial" name="latitud_inicial" placeholder="0.00" type="text">
                        </input>
                    </div>
                    <label class="col-md-2 control-label">
                        <font color="red" size="2">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as" id="longitud_inicial" name="longitud_inicial" placeholder="0.00" type="text">
                        </input>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as" id="latitud_final" name="latitud_final" placeholder="0.00" type="text">
                        </input>
                    </div>
                    <label class="col-md-2 control-label">
                        LON:
                    ...
                    <div class="col-md-3">
                        <input class="form-control text-right corde bnc am-as" id="longitud_final" name="longitud_final" placeholder="0.00" type="text">
                        </input>
                    </div>
                </div>
                <div class="form-group col-md-10">
